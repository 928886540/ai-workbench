...
_MODE_NAMES: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "k2_tifa_plus_v70": ("TIFA+ V7", ("tifa-plus-v7", "tifaplus-v7", "\u8482\u6cd5\u589e\u5f3aV7")),
    "k2_queen_marika_v70": ("\u739b\u8389\u5361 V7", ("marika-v7", "\u739b\u8389\u5361V7", "\u739b\u4e3d\u5361V7")),
    "k2_girls_flux_v70": ("Flux \u5c11\u5973 V7", ("girls-flux-v7", "flux-girl-v7", "flux\u5c11\u5973V7")),
    "k2_mature_manhwa_v70": ("\u6210\u719f\u97e9\u6f2b V7", ("mature-manhwa-v7", "\u97e9\u6f2bV7")),
    "k2_boa_hancock_v70": ("\u5973\u5e1d V7", ("hancock-v7", "boa-hancock-v7", "\u5973\u5e1dV7")),
    "k2_eliska_v70": ("Eliska V7", ("eliska-v7", "\u827e\u8389\u4e1d\u5361V7")),
