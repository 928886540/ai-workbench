        ...
        [
            ...
            AgentTool(
                ...
                description=(
                    ...
                    "the user explicitly supplied them. For a follow-up such as '再来一张' or "
                    "'换成韩漫风', carry forward the latest unambiguous image subject from the "
                    "conversation; never send the bare follow-up as source_text. Phrases such as "
                    "'随便一种模式都行' mean "
